...
expire_time_utc = (now_utc + datetime.timedelta(minutes=15)).strftime('%Y%m%d%H%M%S')
...
params = {
    ...
    'vnp_Amount': '5000000',
    'vnp_CreateDate': current_time_utc, # UTC Time
    'vnp_CurrCode': 'VND',
    ...
    'vnp_ExpireDate': expire_time_utc # UTC Time
}
...
try_method("Sign Raw (UTC Time)", urllib.parse.quote, sign_on_encoded=False)
try_method("Sign Encoded (UTC Time)", urllib.parse.quote, sign_on_encoded=True)
