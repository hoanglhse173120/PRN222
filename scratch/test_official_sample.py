...
params = {
    ...
    'vnp_Locale': 'vn',
    'vnp_OrderInfo': 'Thanh toan don hang', # Official sample value
    'vnp_OrderType': 'other',
...
try_method("Sign Encoded Plus (spaces as +)", urllib.parse.quote_plus, sign_on_encoded=True)
try_method("Sign Encoded %20 (spaces as %20)", lambda s: urllib.parse.quote(s, safe=''), sign_on_encoded=True)
try_method("Sign Raw", lambda s: urllib.parse.quote(s, safe=''), sign_on_encoded=False)
