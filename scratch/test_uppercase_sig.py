...
def try_method(name, encode_fn, sign_on_encoded, uppercase_sig):
    if sign_on_encoded:
        sign_parts = []
...
try_method("Sign Encoded Upper (Lowercase Sig)", urllib.parse.quote, sign_on_encoded=True, uppercase_sig=False)
try_method("Sign Encoded Upper (Uppercase Sig)", urllib.parse.quote, sign_on_encoded=True, uppercase_sig=True)
try_method("Sign Raw (Lowercase Sig)", urllib.parse.quote, sign_on_encoded=False, uppercase_sig=False)
try_method("Sign Raw (Uppercase Sig)", urllib.parse.quote, sign_on_encoded=False, uppercase_sig=True)
