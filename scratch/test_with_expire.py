...
# Calculate current time and expire time (15 mins later)
...
params = {
    ...
    'vnp_ExpireDate': expire_time # Added mandatory parameter
}
...
try_method("Sign Raw with ExpireDate", urllib.parse.quote, sign_on_encoded=False)
try_method("Sign Encoded with ExpireDate", urllib.parse.quote, sign_on_encoded=True)
